...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Born\Restrictions\Model\Entity::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('born_restrictions_entity');
            ...
            $this->dataPersistor->set('born_restrictions_entity', $data);
