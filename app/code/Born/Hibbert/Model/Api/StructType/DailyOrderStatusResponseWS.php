...
/**
 * This class stands for DailyOrderStatusResponseWS StructType
 * @subpackage Structs
 */
class DailyOrderStatusResponseWS extends AbstractStructBase
{
    /**
     * The errors
    ...
    /**
     * Constructor method for DailyOrderStatusResponseWS
     * @uses DailyOrderStatusResponseWS::setErrors()
     * @uses DailyOrderStatusResponseWS::setNumberOfOrderStatus()
     * @uses DailyOrderStatusResponseWS::setOrderStatus()
     * @uses DailyOrderStatusResponseWS::setResponseStatusCode()
     ...
     * @param \Born\Hibbert\Model\Api\ArrayType\ArrayOfErrorCodeWS $errors
     * @return \Born\Hibbert\Model\Api\StructType\DailyOrderStatusResponseWS
     */
