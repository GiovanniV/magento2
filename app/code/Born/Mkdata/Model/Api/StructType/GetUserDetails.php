...
/**
 * This class stands for GetUserDetails StructType
 * @subpackage Structs
 */
class GetUserDetails extends AbstractStructBase
{
     ...
     * @uses GetUserDetails::setCredentials()
     * @param \Born\Mkdata\Model\Api\StructType\DPLv31Credentials $credentials
     */
    public function __construct(\Born\Mkdata\Model\Api\StructType\DPLv31Credentials $credentials = null)
    {
        $this
     ...
     * @param \Born\Mkdata\Model\Api\StructType\DPLv31Credentials $credentials
     * @return \Born\Mkdata\Model\Api\StructType\GetUserDetails
     */
