...
/**
 * This class stands for DelistDynamicScreeningListEntry StructType
 * @subpackage Structs
 */
class DelistDynamicScreeningListEntry extends AbstractStructBase
{
    /**
     * The id
    ...
    public $credentials;
    /**
     * Constructor method for DelistDynamicScreeningListEntry
     * @uses DelistDynamicScreeningListEntry::setId()
     * @uses DelistDynamicScreeningListEntry::setIdIsCustomers()
     * @uses DelistDynamicScreeningListEntry::setCredentials()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Born\Mkdata\Model\Api\StructType\DelistDynamicScreeningListEntry
     */
