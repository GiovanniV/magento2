...
namespace Born\Navigation\Plugin\Catalog\Html;

use Magento\Catalog\Model\Category;
use Magento\Framework\Data\Collection;
use Magento\Framework\Data\Tree\Node;
use Magento\Catalog\Plugin\Block\Topmenu as PluginTopMenu;

/**
 * Plugin for top menu block
 */
class Topmenu extends PluginTopMenu
{
    /**
     * Catalog category
     *
    ...
    {
        $categoryLinkText = false;
        $categoryLink = false;
        if($category->getCustomAttribute('category_link_text')) {
            $categoryLinkText = $category->getCustomAttribute('category_link_text')->getValue();
        }
        if($category->getCustomAttribute('category_link')) {
            $categoryLink = $category->getCustomAttribute('category_link')->getValue();
        }
        return [
            'name' => $categoryLinkText ? $categoryLinkText : $category->getName(),
            'id' => 'category-node-' . $category->getId(),
            'url' => $categoryLink ? $categoryLink : $this->catalogCategory->getCategoryUrl($category),
    ...
    protected function getCategoryTree($storeId, $rootId)
    {
        ...
        $collection->addAttributeToSelect(['name','category_link_text','category_link']);
